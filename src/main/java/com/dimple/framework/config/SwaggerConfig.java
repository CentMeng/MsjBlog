...
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo() {
        ...
        return new ApiInfoBuilder()
                // 设置标题
                .title("标题：MsjBlog后台管理系统")
                // 描述
                .description("代码开源:https://github.com/CentMeng/MsjBlog")
                // 作者信息
                .contact(new Contact(dimpleBlogConfig.getName(), "http://39.100.121.104:81", "mengshaojie@188.com"))
                // 版本
